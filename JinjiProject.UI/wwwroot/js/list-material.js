                ...
                <td>${materialsPerPage * (currentPage - 1) + index + 1}</td>
                                            ...
                                            <td>
                                                ...
                                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                                                    <a class="dropdown-item text-primary" href="/Admin/Material/UpdateMaterial/${material.id}">Güncelle</a>
                                                    <a class="dropdown-item text-primary" onclick="loadMaterialData(${material.id})" id="modalOpener" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="${material.id}">Detaylar</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item text-danger" href="/Admin/Material/SoftDelete/${material.id}">Sil</a>
                                                </ul>
                                            </td>`;
