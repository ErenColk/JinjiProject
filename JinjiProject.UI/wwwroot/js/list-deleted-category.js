              ...
              <td>${categorysPerPage * (currentPage - 1) + index + 1}</td>
                                            ...
                                            <td>
                                                ...
                                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                                                    <a class="dropdown-item text-success " href="/Admin/Category/AddAgainCategory/${category.id}">Tekrar Ekle</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item text-danger" onclick="loadCategoryHardDeleteData(${category.id})" id="modalOpener" data-bs-toggle="modal" data-bs-target="#hardDeleteModal" data-id="${category.id}">Veriyi Sil</a>
                                                </ul>
                                            </td>`;
