               ...
               <td>${genresPerPage * (currentPage - 1) + index + 1}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                                                        <a class="dropdown-item " href="/Admin/Genre/UpdateGenre/${genre.id}">Güncelle</a>
                                                        <a class="dropdown-item " id="modalOpener" onclick="loadGenreData(${genre.id})" data-bs-toggle="modal" data-bs-target="#genreDetailModal" data-id="${genre.id}">Detaylar</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item text-danger" href="/Admin/Genre/SoftDelete/${genre.id}">Sil</a>
                                                    </ul>
                                                </td>`;
