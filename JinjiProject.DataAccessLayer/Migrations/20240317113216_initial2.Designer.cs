...
namespace JinjiProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20240317113216_initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JinjiProject.Core.Entities.Concrete.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JinjiProject.Core.Entities.Concrete.AppUser", b =>
                {
            ...
            modelBuilder.Entity("JinjiProject.Core.Entities.Concrete.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JinjiProject.Core.Entities.Concrete.Subscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JinjiProject.Core.Entities.Concrete.Admin", b =>
                {
                    b.HasOne("JinjiProject.Core.Entities.Concrete.AppUser", "AppUser")
                        .WithOne("Admin")
                        .HasForeignKey("JinjiProject.Core.Entities.Concrete.Admin", "AppUserId")
            ...
            modelBuilder.Entity("JinjiProject.Core.Entities.Concrete.Product", b =>
                {
                    ...
                    b.HasOne("JinjiProject.Core.Entities.Concrete.Material", "Material")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JinjiProject.Core.Entities.Concrete.AppUser", null)
                        .WithMany()
